...
/** Fixed-width monospace table for WhatsApp code blocks. */
final class MonoTable {
    private final List<String[]> rows = new ArrayList<>();
    private String[] header;

    MonoTable header(String... cols) { this.header = cols; return this; }
    MonoTable row(String... cols) { rows.add(cols); return this; }
